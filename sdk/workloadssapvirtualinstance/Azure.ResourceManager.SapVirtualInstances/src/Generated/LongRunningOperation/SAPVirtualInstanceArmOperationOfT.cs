...
#pragma warning disable SA1649 // File name should match first type name
    internal class SAPVirtualInstanceArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of SAPVirtualInstanceArmOperation for mocking. </summary>
        protected SAPVirtualInstanceArmOperation()
        {
        }

        internal SAPVirtualInstanceArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SAPVirtualInstanceArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "SAPVirtualInstanceArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
