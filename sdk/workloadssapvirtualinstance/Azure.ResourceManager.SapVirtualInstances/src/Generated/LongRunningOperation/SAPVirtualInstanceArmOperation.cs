...
#pragma warning disable SA1649 // File name should match first type name
    internal class SAPVirtualInstanceArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal SAPVirtualInstanceArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SAPVirtualInstanceArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "SAPVirtualInstanceArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
