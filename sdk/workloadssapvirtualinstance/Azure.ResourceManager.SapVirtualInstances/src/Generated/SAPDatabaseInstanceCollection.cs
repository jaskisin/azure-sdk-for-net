...
namespace Azure.Workloads.SAPVirtualInstance
{
    ...
    public partial class SAPDatabaseInstanceCollection : ArmCollection, IEnumerable<SAPDatabaseInstanceResource>, IAsyncEnumerable<SAPDatabaseInstanceResource>
    {
        ...
        {
            _sapDatabaseInstanceClientDiagnostics = new ClientDiagnostics("Azure.Workloads.SAPVirtualInstance", SAPDatabaseInstanceResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SAPDatabaseInstanceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string databaseInstanceName, SAPDatabaseInstanceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SAPVirtualInstanceArmOperation<SAPDatabaseInstanceResource>(new SAPDatabaseInstanceOperationSource(Client), _sapDatabaseInstanceClientDiagnostics, Pipeline, _sapDatabaseInstanceRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, databaseInstanceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
