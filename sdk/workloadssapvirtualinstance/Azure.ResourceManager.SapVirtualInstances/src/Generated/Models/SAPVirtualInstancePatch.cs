...
namespace Azure.Workloads.SAPVirtualInstance.Models
{
    ...
    public partial class SAPVirtualInstancePatch
    {
        ...
        internal SAPVirtualInstancePatch(IDictionary<string, string> tags, ManagedServiceIdentity identity, UpdateSAPVirtualInstanceProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
            Identity = identity;
